...
public class SCSMMyrmexWeapon extends SCSimplyMore {
    public SCSMMyrmexWeapon(Tier toolMaterial, Properties settings, WeaponType weaponType, String... repairIngredient) {
        super(toolMaterial, settings, weaponType, repairIngredient);
    }
