...
public class SCSMLightningDragonboneWeapon extends SCSimplyMore implements LightningDragonboneWeaponBehavior {
    public SCSMLightningDragonboneWeapon(WeaponType weaponType) {
