...
public class IceAndFireCompat {
    ...
    public static final RegistryObject<Item> COPPER_LONGSWORD = IAF_COMPAT_ITEMS.register("copper_longsword",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.LONGSWORD_POSITIVE_MODIFIER - SimplyConfigValues.LONGSWORD_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_TWINBLADE = IAF_COMPAT_ITEMS.register("copper_twinblade",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.TWINBLADE_POSITIVE_MODIFIER - SimplyConfigValues.TWINBLADE_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_RAPIER = IAF_COMPAT_ITEMS.register("copper_rapier",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.RAPIER_POSITIVE_MODIFIER - SimplyConfigValues.RAPIER_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_KATANA = IAF_COMPAT_ITEMS.register("copper_katana",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.KATANA_POSITIVE_MODIFIER - SimplyConfigValues.KATANA_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_SAI = IAF_COMPAT_ITEMS.register("copper_sai",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.SAI_POSITIVE_MODIFIER - SimplyConfigValues.SAI_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_SPEAR = IAF_COMPAT_ITEMS.register("copper_spear",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.SPEAR_POSITIVE_MODIFIER - SimplyConfigValues.SPEAR_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_GLAIVE = IAF_COMPAT_ITEMS.register("copper_glaive",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.GLAIVE_POSITIVE_MODIFIER - SimplyConfigValues.GLAIVE_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_WARGLAIVE = IAF_COMPAT_ITEMS.register("copper_warglaive",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.WARGLAIVE_POSITIVE_MODIFIER - SimplyConfigValues.WARGLAIVE_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_CUTLASS = IAF_COMPAT_ITEMS.register("copper_cutlass",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.CUTLASS_POSITIVE_MODIFIER - SimplyConfigValues.CUTLASS_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_CLAYMORE = IAF_COMPAT_ITEMS.register("copper_claymore",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.CLAYMORE_POSITIVE_MODIFIER - SimplyConfigValues.CLAYMORE_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_GREATHAMMER = IAF_COMPAT_ITEMS.register("copper_greathammer",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.GREATHAMMER_POSITIVE_MODIFIER - SimplyConfigValues.GREATHAMMER_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_GREATAXE = IAF_COMPAT_ITEMS.register("copper_greataxe",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.GREATAXE_POSITIVE_MODIFIER - SimplyConfigValues.GREATAXE_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_CHAKRAM = IAF_COMPAT_ITEMS.register("copper_chakram",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.CHAKRAM_POSITIVE_MODIFIER - SimplyConfigValues.CHAKRAM_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_SCYTHE = IAF_COMPAT_ITEMS.register("copper_scythe",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.SCYTHE_POSITIVE_MODIFIER - SimplyConfigValues.SCYTHE_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_HALBERD = IAF_COMPAT_ITEMS.register("copper_halberd",
            () -> new SimplySwordsSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + SimplyConfigValues.HALBERD_POSITIVE_MODIFIER - SimplyConfigValues.HALBERD_NEGATIVE_MODIFIER),
    ...
    public static final RegistryObject<Item> COPPER_GREAT_KATANA = IAF_COMPAT_ITEMS.register("copper_great_katana",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getGreatKatanaDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_GRANDSWORD = IAF_COMPAT_ITEMS.register("copper_grandsword",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getGrandswordDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_BACKHAND_BLADE = IAF_COMPAT_ITEMS.register("copper_backhand_blade",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getBackhandBladeDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_LANCE = IAF_COMPAT_ITEMS.register("copper_lance",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getLanceDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_KHOPESH = IAF_COMPAT_ITEMS.register("copper_khopesh",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getKhopeshDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_DAGGER = IAF_COMPAT_ITEMS.register("copper_dagger",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getDaggerDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_PERNACH = IAF_COMPAT_ITEMS.register("copper_pernach",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getPernachDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_QUARTERSTAFF = IAF_COMPAT_ITEMS.register("copper_quarterstaff",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getQuarterstaffDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_GREAT_SPEAR = IAF_COMPAT_ITEMS.register("copper_great_spear",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getGreatSpearDamageModifier()),
    ...
    public static final RegistryObject<Item> COPPER_DEER_HORNS = IAF_COMPAT_ITEMS.register("copper_deer_horns",
            () -> new SimplyMoreSwordItem(CustomTiers.COPPER,
                    (int) (SCCommonConfigs.COPPER_DAMAGE_MODIFIER.get() + 3 + SimplyConfigValues.attributesSimplyMore.getDeerHornsDamageModifier()),
